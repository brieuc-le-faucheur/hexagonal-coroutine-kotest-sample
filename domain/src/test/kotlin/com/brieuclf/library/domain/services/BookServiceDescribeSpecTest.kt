...
class BookServiceDescribeSpecTest : DescribeSpec({
    ...
    describe("BookService.createBook") {
        it("Creates a book when author exists") {
        ...
        it("Does not create book when author does not exist") {
    ...
    describe("BookService.isBookBorrowed") {
        it("Returns true when book is borrowed") {
        ...
        it("Returns false when book is not borrowed") {
